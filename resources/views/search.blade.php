            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Search</h2>
                ...
                <div class="row">
                    ...
                    <!-- ============================================================== -->
                      ...
                      @if (empty($resultsCat[0]) && empty($results_news[0]))
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                       ...
                       @elseif (!empty($resultsCat[0]))     
                   
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Search category Table</h5>
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                   ...
                                                   @foreach($resultsCat as $result)
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <a href="{{ route('category.edit', $result->id) }}" class="btn btn-success active">Edit</a>

                                                              <a href="{{ route('category.show', $result->id) }}" class="btn btn-primary active">Show</a>

                                                              <form method="post" action="{{ route('category.destroy' , $result->id)}} " style="display: inline-block;" id="delCat">
                ...
                <div class="row">
                    @elseif (!empty($results_news[0]))
                    <!-- ============================================================== -->
                    <!-- basic table  -->
                    <!-- ============================================================== -->
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Search News Table</h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        <thead>
