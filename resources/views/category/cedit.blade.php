     ...
     <!-- ============================================================== -->
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" method="POST" action="{{ route('category.update' ,$category->id) }}" novalidate="">
                                        ...
                                        <div class="row pt-2 pt-sm-5 mt-1">
                                            <div class="col-sm-12 pl-0">
                                                <p class="text-right">
                                                    <button type="submit" class="btn btn-space btn-primary">Edit Category</button>
                                                </p>
                                            </div>
                                        </div>
                                    </form>
