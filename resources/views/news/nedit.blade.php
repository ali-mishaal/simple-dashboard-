     ...
     <!-- ============================================================== -->
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" method="POST" action="{{ route('news.update' , $editArray[0]['id']) }}" novalidate="">
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group row{{ $errors->has('title') ? '           has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="title" type="text" class="form-control" name="title" value="{{ $editArray[0]['title'] }}" required autofocus>
                                        ...
                                        <div class="form-group row{{ $errors->has('content') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea id="content" class="form-control" name="content" value="{{ $editArray[0]['content'] }}" required>{{ $editArray[0]['content'] }}</textarea>
                                        ...
                                        <div class="form-group row{{ $errors->has('category') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                 <select name="category">
                                                      @foreach($editArray[1] as $category)
